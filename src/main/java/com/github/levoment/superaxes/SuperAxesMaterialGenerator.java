...
public class SuperAxesMaterialGenerator implements ToolMaterial {
    ...
    public SuperAxesMaterialGenerator(ToolMaterial toolMaterial) {
        ...
        if (toolMaterial.getMiningSpeed() <= 2.0f) this.miningSpeed = toolMaterial.getMiningSpeed();
        else this.miningSpeed = toolMaterial.getMiningSpeed() / 2.0f;
        ...
        float calculatedAxeAttackSpeed = -(float)Math.round(toolMaterial.getMiningSpeed() / 4.0f) - 1.5f;
